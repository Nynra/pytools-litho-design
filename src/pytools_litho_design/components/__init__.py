"""This init file imports all the default components from gdsfactory and adds custom components.

The custom components should be inported after the default imports to make sure they are not overwritten
by the default components.
"""
...
# The following import is needed to make sure the custom components are imported
from .__custom__init__ import *
